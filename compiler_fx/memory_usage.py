...
print(f"--- Before creating model instance ----------------------------")
print_memory_usage()
print(f"-----------------------------------------------------------")

t1 = TestModel()

print(f"--- After creating model instance: model = TestModel() ----------------------------")
print_memory_usage()
print(f"-----------------------------------------------------------")
...
print(f"--- After symbolic tracing: gm = fx.symbolic_trace(model) ----------------------------")
print_memory_usage()
print(f"-----------------------------------------------------------")
...
print(f"--- After counting total parameters: get_total_params(model) ----------------------------")
print_memory_usage()
print(f"-----------------------------------------------------------")
...
for i in range(2):
    ...
    print(f"--- After forward: fx_run.fx_forward() ----------------------------")
    print_memory_usage()
    print(f"-----------------------------------------------------------")
    loss1 = fx_run.loss
    fx_run.fx_backward(loss1)

    print(f"--- After backward: fx_run.fx_backward() ----------------------------")
    print_memory_usage()
    print(f"-----------------------------------------------------------")
    ...
    print(f"--- After optimizer step: step() ----------------------------")
    print_memory_usage()
    print(f"-----------------------------------------------------------")
