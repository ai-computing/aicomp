...
#                  --master_addr="X.X.X.X" --master_port=29500 fx_dist_pp_training_type-C_gpt2-medium_gpu.py
#      <machine #1>
...
#model = GPT2LMHeadModel.from_pretrained("gpt2-medium", config=config, ignore_mismatched_sizes=True)
