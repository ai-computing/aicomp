...
#
#   Micro-batch is supported in this PoC, and applied to the GPT-J model (GPU version)
#
#
#  Sample Usage:
#      <machine #0>
#            torchrun --nproc_per_node=1 --nnodes=2 --node_rank=0
#                  --master_addr="X.X.X.X" --master_port=29500 fx_dist_pp_training_type-C_gptj_gpu.py
#      <machine #1>
