...
#
#   Micro-batch is supported in this PoC, and applied to the GPT2 model (CPU version)
#
#
#  Sample Usage:
#      <machine #0>
#            torchrun --nproc_per_node=1 --nnodes=2 --node_rank=0
#                  --master_addr="X.X.X.X" --master_port=29500 fx_dist_pp_training_type-A_gpt2-medium.py
#      <machine #1>
