...
optimus_p = Optimus_p(model, num_mb, use_gpu=True, activation_ckpt=True, force_free_mem=True, display_mem=True, swap_opt_in_fwdbwd=True, ir_analyze=IR_Anal.SEQUENTIAL, dynamo_capture=args.dynamo_capture)
